...
// GetDiseasesUnauthorizedCode is the HTTP code returned for type GetDiseasesUnauthorized
const GetDiseasesUnauthorizedCode int = 401

/*
GetDiseasesUnauthorized internal server error

swagger:response getDiseasesUnauthorized
*/
...
// NewGetDiseasesUnauthorized creates GetDiseasesUnauthorized with default headers values
func NewGetDiseasesUnauthorized() *GetDiseasesUnauthorized {

	return &GetDiseasesUnauthorized{}
}

// WithPayload adds the payload to the get diseases unauthorized response
func (o *GetDiseasesUnauthorized) WithPayload(payload interface{}) *GetDiseasesUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get diseases unauthorized response
func (o *GetDiseasesUnauthorized) SetPayload(payload interface{}) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *GetDiseasesUnauthorized) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
