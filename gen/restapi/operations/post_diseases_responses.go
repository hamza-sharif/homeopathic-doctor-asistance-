...
// PostDiseasesUnauthorizedCode is the HTTP code returned for type PostDiseasesUnauthorized
const PostDiseasesUnauthorizedCode int = 401

/*
PostDiseasesUnauthorized internal server error

swagger:response postDiseasesUnauthorized
*/
...
// NewPostDiseasesUnauthorized creates PostDiseasesUnauthorized with default headers values
func NewPostDiseasesUnauthorized() *PostDiseasesUnauthorized {

	return &PostDiseasesUnauthorized{}
}

// WithPayload adds the payload to the post diseases unauthorized response
func (o *PostDiseasesUnauthorized) WithPayload(payload interface{}) *PostDiseasesUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post diseases unauthorized response
func (o *PostDiseasesUnauthorized) SetPayload(payload interface{}) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *PostDiseasesUnauthorized) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
